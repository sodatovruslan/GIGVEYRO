...
revision: str = '0015'
down_revision: Union[str, None] = 'stage13_notif'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_unmatched_transfers_created_at'), 'unmatched_transfers', ['created_at'], unique=False)
    op.create_index(op.f('ix_unmatched_transfers_tx_hash'), 'unmatched_transfers', ['tx_hash'], unique=True)
