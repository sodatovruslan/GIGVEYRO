...
down_revision: str | None = "stage12_deal_payment_workflow"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "deal_notifications", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "deposit_notifications", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "appeal_notifications", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "withdrawal_notifications", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_notification_preferences_account_id"),
        "notification_preferences",
        ["account_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_notifications_account_id"), "notifications", ["account_id"], unique=False
    )
