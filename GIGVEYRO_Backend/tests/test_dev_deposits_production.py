...
def test_dev_simulate_route_not_mounted_when_app_env_is_production():
    ...
    script = (
        ...
        "os.environ['ALLOWED_HOSTS'] = '[\"app.example.com\"]'; "
        "os.environ['REDIS_URL'] = 'redis://redis.internal:6379/0'; "
        "os.environ['REALTIME_BROKER'] = 'redis'; "
        "os.environ['RATE_LIMIT_FAIL_MODE'] = 'closed'; "
