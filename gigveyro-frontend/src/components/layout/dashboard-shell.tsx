...
type NavigationKey = "overview"|"home"|"accounts"|"deals"|"deposits"|"funding"|"withdrawals"|"payouts"|"appeals"|"notifications"|"analytics"|"fees"|"treasury"|"integrations"|"audit"|"wallet"|"requisites"|"settings";
interface NavigationItem { href: string; label: NavigationKey; glyph: string }

const navigation: Record<UserRole, NavigationItem[]> = {
  owner: [
    { href: "/owner", label: "overview", glyph: "◇" }, { href: "/owner/accounts", label: "accounts", glyph: "◎" }, { href: "/owner/deals", label: "deals", glyph: "⇄" }, { href: "/owner/deposits", label: "deposits", glyph: "↓" }, { href: "/owner/withdrawals", label: "withdrawals", glyph: "↗" }, { href: "/owner/payouts", label: "payouts", glyph: "⇒" }, { href: "/owner/appeals", label: "appeals", glyph: "!" }, { href: "/owner/notifications", label: "notifications", glyph: "○" }, { href: "/owner/analytics", label: "analytics", glyph: "⌁" }, { href: "/owner/fees", label: "fees", glyph: "%" }, { href: "/owner/treasury", label: "treasury", glyph: "#" }, { href: "/owner/integrations", label: "integrations", glyph: "⌘" }, { href: "/owner/audit", label: "audit", glyph: "≡" }, { href: "/owner/settings", label: "settings", glyph: "⚙" },
  ],
  user: [
  ...
  merchant: [
    { href: "/merchant", label: "home", glyph: "◇" }, { href: "/merchant/wallet", label: "wallet", glyph: "₮" }, { href: "/merchant/deals", label: "deals", glyph: "⇄" }, { href: "/merchant/withdrawals", label: "withdrawals", glyph: "↗" }, { href: "/merchant/appeals", label: "appeals", glyph: "!" }, { href: "/merchant/notifications", label: "notifications", glyph: "○" }, { href: "/merchant/settings", label: "settings", glyph: "⚙" },
  ],
};
